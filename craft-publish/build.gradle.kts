    ...
    publications {
        fun MavenPublication.setup(target: Project) {
            ...
            pom {
                ...
                description.set("유튜브 \"코벌\" 종합 프로젝트를 위한, 의존성 라이브러리입니다.")
                ...
                developers {
                    developer {
                        id.set("cobeol")
                        name.set("코벌")
                        email.set("cobeol11111010111@gmail.com")
                        url.set("https://github.com/cobeol")
                ...
                scm {
                    connection.set("scm:git:git://github.com/cobeol/${rootProject.name}.git")
                    developerConnection.set("scm:git:ssh://github.com:cobeol/${rootProject.name}.git")
                    url.set("https://github.com/cobeol/${rootProject.name}")
                }
            }
        }
